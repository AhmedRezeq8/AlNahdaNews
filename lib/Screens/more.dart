...
class _MoreState extends State<More> {
  ...
  _facebook() async {
    const url = 'https://www.facebook.com/alnahdanews.lb';
  ...
  _twitter() async {
    const url = 'https://twitter.com/alnahdanews_lb';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
  ...
  _youtube() async {
    const url = 'https://www.youtube.com/channel/UCKLaAVZjGuSZJDHLhn4dyCw';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
  ...
  _telegram() async {
    const url = 'https://t.me/alnahdanews1';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
  ...
  // _rss() async {
  //   const url = 'https://alnahdanews.com//rss';
  //   if (await canLaunch(url)) {
  //     await launch(url);
  //   } else {
  //     throw 'Could not launch $url';
