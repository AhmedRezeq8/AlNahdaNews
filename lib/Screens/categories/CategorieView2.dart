...
class CategorieView2 extends StatefulWidget {
  CategorieView2({Key key, this.title, this.catId}) : super(key: key);
  final String title;
  final int catId;
  @override
  _CategorieView2State createState() => _CategorieView2State();
}

class _CategorieView2State extends State<CategorieView2> {
